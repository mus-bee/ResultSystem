		...
		<nav class="top-nav">
			<div class="shell">
				...
				<ul>
					...
					<li class="active"><span><a href="check_student_result.php">Check Student Result</a></span></li>
...
<form action="check_student_result.php" method="POST">
<tr>
...
?>
<!--<th bgcolor="white"> <a href="admin/delete_result.php?id=<?php echo $row['id']; ?>" >Delete</a></th>-->
