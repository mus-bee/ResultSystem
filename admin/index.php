				...
				<div class="shell">
					<div class="container">
						...
						<section class="testimonial">
							<h2><blink>Administrator Login</blink></h2>
							<p><strong></strong>
...
<center>
<table width="600"border="0"align="center"cellpadding="10"cellspacing="3"bgcolor="black">
<tr>
<form action="index.php"method="post">
<td>
<table width="100%"border="0"cellpadding="10"cellspacing="1"bgcolor="#FFFFFF">
<tr>
<th colspan="3" bgcolor="black"><font color="white"> <marquee behavior="alternate">LOGIN</marquee></th>
<tr>
</tr>
<tr>
<td valign="top"><strong>Username:</strong> </td>
<td valign="top">:</td>
<td> <input type="text" name="username" required> </textarea> </td>
</tr>
<tr>
...
<td>&nbsp;</td>
<td>&nbsp;</td>
<td> <input type="submit"name="login"value="Login" /> <input type="reset" value="Clear">
