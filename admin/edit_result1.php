...
<td><input type="text" value="<?php echo $row['reg_no'];?>"name="reg_no" /></td>
</tr>
<tr>
<td><strong>Department</strong></td>
<td><input type="text" value="<?php echo $row['dept'];?>"name="dept" /></td>
</tr>
<tr>
...
<td><input type="text" value="<?php echo $row['expiry'];?>"name="expiry" /></td>
</tr>
<tr>
<td><strong>State</strong></td>
<td><input type="text" value="<?php echo $row['state'];?>"name="state" /></td>
</tr>
<tr>
<td><strong>Bloog Group</strong></td>
<td><input type="text" value="<?php echo $row['blood_group'];?>"name="blood_group" /></td>
</tr>
<tr>
...
$result = mysqli_query($con, "Select * from exam where name='$name'");
...
<tr>
<td><input type="text" value="<?php echo $row['s1_ca1'];?> name="s1_ca1" ></td>
