		...
		<nav class="top-nav">
			<div class="shell">
				...
				<ul>
					...
					<li><span><a href="create_result.php">Create Result</a></span></li>
					<li><span><a href="print_result.php">Print Result</a></span></li>
...
<div class="cl">&nbsp;</div>
					...
					<!-- end of shell -->	
					<div class="header-bottom"><h1><center><font color="#FFFFFF">SECONDARY SCHOOL RESULT PROCESSING SYSTEM</h1></center></font></div>
				</div>
			</header>
			<!-- end of header -->
			<!-- main -->
...
<tr>
<th colspan="10" bgcolor="black"><font color="white"><?php echo $class; ?> Student</th>
</tr>
<tr>
...
?>
<th bgcolor="white"> <a href="delete_result.php?id=<?php echo $row['id']; ?>" target="window">Delete</a></th>
<th bgcolor="white"> <a href="print_result_script.php?id=<?php echo $row['id']; ?>" target="window">Print Result</a></th>
<?php
}
}
mysqli_close($con);
