				...
				<div class="shell">
					<div class="container">
						...
						<section class="testimonial">
							<h2>Welcome <blink>Administrator!</blink></h2>
							<p><strong></strong>
							
							As admin you can create new result for student you can add subject or delete subject you can delete student record or student result, after finishing editing on this site we recommend you to logout from the site for security reason because admin section is the main control section of the website.s</p>
						</section>
						<!-- testimonial -->
