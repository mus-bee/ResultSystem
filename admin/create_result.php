			...
			<div class="main">
				...
				<div class="shell">
					<div class="container">
						...
						Select Class and Course of Study to select a student
...
?>
<center>
        <td width="45%" height="186" align="center"><div align="left"></div>
...
$result = mysqli_query($con, "Select * from student where class='$class' and class_type='$subject_for'");
?>
<table border ="1" width="80%" cellpadding="5">
<tr>
<th colspan="10" bgcolor="black"><font color="white"><?php echo $class; ?><br><?php echo $subject_for; ?> Students</th>
</tr>
<tr>
<th bgcolor="white">First Name</th>
<th bgcolor="white">Last Name</th>
<th bgcolor="white">Gender</th>
<th bgcolor="white">Admission No</th>
...
<th bgcolor="white"> <a href="create_result_script.php?id=<?php echo $row['id']; ?>" target="window">Create Result</a></th>
<?php
}
}
mysqli_close($con);
